...
export function CreateAdModal(){
  ...
  //event: FormEvent - para não deixar ir apra outra página
     ...
     return (
          ...
          <Dialog.Content className='fixed bg-[#242634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg w-[480px] shadow-lg shadow-black/25'>
            ...
            <form onSubmit={handleCreatedAd} className='mt-8 flex flex-col gap-4' >
              ...
              <div className='flex flex-col gap-2'>
                <label htmlFor="name">Seu nick name?</label>
                <Input name="name" id="name" type="text" placeholder='Como te chaman dentro do game?' />
              </div>

              <div className='grid grid-cols-2 gap-6'>
                <div  className='flex flex-col gap-2'>
                  <label htmlFor="yearsPlaying">Joga a quanto tempo?</label>
                  <Input name="yearsPlaying" id="yearsPlaying" type="number" placeholder='Tudo bem ser 0 anos' />
                </div>
                <div  className='flex flex-col gap-2'>
                ...
                <div className='flex flex-col gap-2'>
                  <label htmlFor="weekDays">Quando costuma jogar?</label>
                    ...
                    <ToggleGroup.Root type='multiple' className='grid grid-cols-4 gap-2' value={weekDays} onValueChange={setWeekDays} >
                      ...
                      <ToggleGroup.Item value='6' className='w-8 h-8 rounded bg-zinc-900' title='Sábado'>S</ToggleGroup.Item>
                    </ToggleGroup.Root>
                </div>
